...
class GymEpsCard extends StatefulWidget {
  final GymEps gymEps;
  ...
  const GymEpsCard({
    ...
    required this.gymEps,
  }) : super(key: key);

  @override
  State<GymEpsCard> createState() => _GymEpsCardState();
}

class _GymEpsCardState extends State<GymEpsCard> {
  late YoutubePlayerController _controller;

  @override

  void initState() {
    final String videoId = widget.gymEps.videoId;
    if (videoId.isEmpty) {
      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: Text(
              'Published at: ${widget.gymEps.publishedAt}', // Added label for clarity
