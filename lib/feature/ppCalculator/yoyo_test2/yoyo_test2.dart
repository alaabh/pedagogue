...
class _YoyoTest2State extends State<YoyoTest2> {
  List<int> distTOTAL = [
    0,
    0,
    0,
      ...
      body: SingleChildScrollView(
        child: Center(
          child: Container(
            ...
            child: Column(
              children: [
                Text("${intl.yoyo2Title2}"),
                Dimensions.verticalSpacingExtraLarge,
                Text("${intl.yoyo2Title3}"),
                Dimensions.verticalSpacingExtraLarge,
                Row(
                  ...
                  child: FilledButton(
                      ...
                      onPressed: () {
                        setState(() {
                          ...
                          double calcval = (distance * 0.0136 + 45.3);
