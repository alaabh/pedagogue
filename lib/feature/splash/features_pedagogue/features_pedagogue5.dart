...
class Features5 extends StatefulWidget {
  const Features5({super.key});

  @override
  State<Features5> createState() => _Features5State();
}

class _Features5State extends State<Features5> {
  ...
  void initState() {
    ...
    _controller = VideoPlayerController.networkUrl(Uri.parse(
        'https://sportspedagogue.com/wp-content/uploads/2023/03/nutrition.mp4'))
      ..initialize().then((_) {
