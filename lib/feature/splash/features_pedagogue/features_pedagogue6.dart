...
class Features6 extends StatefulWidget {
  const Features6({super.key});

  @override
  State<Features6> createState() => _Features6State();
}

class _Features6State extends State<Features6> {
  ...
  void initState() {
    ...
    _controller = VideoPlayerController.networkUrl(Uri.parse(
        'https://sportspedagogue.com/wp-content/uploads/2023/03/statistique.mp4'))
      ..initialize().then((_) {
