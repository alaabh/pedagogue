...
import 'package:pedagogue/feature/splash/features_pedagogue/features_pedagogue8.dart';
...
class Features7 extends StatefulWidget {
  const Features7({super.key});

  @override
  State<Features7> createState() => _Features7State();
}

class _Features7State extends State<Features7> {
  ...
  void initState() {
    ...
    _controller = VideoPlayerController.networkUrl(Uri.parse(
        'https://sportspedagogue.com/wp-content/uploads/2023/03/Video-corder.mp4'))
      ..initialize().then((_) {
