...
class _DevelopmentState extends State<Development> {
  Future<void> _generatePDF() async {
    ...
    final netImage1 = await networkImage(
        'https://www.mobile.sportspedagogue.com/24_${intl.imgLang}.png');
    final netImage2 = await networkImage(
        'https://www.mobile.sportspedagogue.com/25_${intl.imgLang}.png');
    ...
    saveAndLaunchFile(bytes, "${intl.developmentList}.pdf");
  }

  @override
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(title: Text("${intl.developmentList}")),
