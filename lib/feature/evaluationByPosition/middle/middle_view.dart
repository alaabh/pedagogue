...
import 'package:pedagogue/feature/evaluationByPosition/middle/evaluation_middle.dart';
...
class MiddleView extends StatefulWidget {
  ...
  const MiddleView({super.key, this.middleModel});
...
class _MiddleViewState extends State<MiddleView> {
  ...
  Future<void> loadData() async {
    ...
    if (widget.middleModel != null) {
      _Player.text = widget.middleModel!.player ?? '';
      _Team.text = widget.middleModel!.team ?? '';
      _Season.text = widget.middleModel!.season ?? '';
      _Month.text = widget.middleModel!.month ?? '';
    }
    playerLoader = true;
  }
                            ...
                            child: FilledButton(
                              onPressed: () {
                                Navigator.of(context).push(MaterialPageRoute(
                                    builder: (context) => EvaluationMiddle(
                                          middleModel: widget.middleModel,
                                          player: _Player.text,
                                          team: _Team.text,
                                          season: _Season.text,
                                          month: _Month.text,
