...
import 'package:pedagogue/controller/displineController/step1_controller.dart';
...
class _PsychologicalQualitesState extends State<PsychologicalQualites> {
  ...
  Step1Controller step1Controller = Step1Controller();
  Future<void> submit() async {
    FocusManager.instance.primaryFocus?.unfocus();

    //if (!(_formKey.currentState?.validate() ?? false)) return;

    Step1Model step1Model = Step1Model(
    ...
    ApiViewHandler.withAlert(
      context: context,
      apiCall: step1Controller.add(step1Model),
