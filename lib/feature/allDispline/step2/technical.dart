...
import 'individualTactic.dart';

class TechnicalStep2 extends StatefulWidget {
  final List<String> controllerPreparationPhysiqueList;
  const TechnicalStep2(
      {super.key, required this.controllerPreparationPhysiqueList});

  @override
  State<TechnicalStep2> createState() => _TechnicalStep2State();
}

class _TechnicalStep2State extends State<TechnicalStep2> {
