...
import 'package:pedagogue/feature/allDispline/step2/technical.dart';

import '../../../l10n/localization.dart';
import '../../../shared/widget/custom_input.dart';

class PreparationPhysiqueStep2 extends StatefulWidget {
  const PreparationPhysiqueStep2({super.key});

  @override
  State<PreparationPhysiqueStep2> createState() =>
      _PreparationPhysiqueStep2State();
}

class _PreparationPhysiqueStep2State extends State<PreparationPhysiqueStep2> {
                          ...
                          child: FilledButton(
                            onPressed: () {
                              Navigator.of(context).push(
                                MaterialPageRoute(
                                  builder: (context) => TechnicalStep2(
