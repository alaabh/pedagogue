...
class RapportSemestre1Model extends BaseModel {
  String? team;
  String? coach;
  String? season;
  String? program;
  ...
  factory RapportSemestre1Model.fromJson(Map<String, dynamic> json) {
    return RapportSemestre1Model(
      team: json['team'],
      coach: json['coach'],
      season: json['season'],
